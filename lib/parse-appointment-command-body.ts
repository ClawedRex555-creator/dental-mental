...
export function parsePatientPayload(raw: unknown): Patient | null {
  ...
  return {
    ...
    passportIssuedBy: asOptionalString(b.passportIssuedBy),
    passportIssuedAt: asOptionalString(b.passportIssuedAt),
    passportIssuerCode: asOptionalString(b.passportIssuerCode),
