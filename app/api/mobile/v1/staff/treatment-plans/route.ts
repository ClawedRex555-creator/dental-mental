...
import { listMobileStaffTreatmentPlans } from "@/lib/mobile-staff-clinic.server";
import {
  isStaffContext,
...
export async function GET(request: Request) {
  ...
  const plans = await listMobileStaffTreatmentPlans(ctx.clinic.clinicId, ctx.session, {
