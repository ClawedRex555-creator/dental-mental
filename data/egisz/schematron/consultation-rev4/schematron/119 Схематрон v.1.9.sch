...
-->
    ...
    <pattern>
        <rule context="ClinicalDocument[number(substring(effectiveTime/@value,1,8))-number(substring(recordTarget/patientRole/patient/birthTime/@value,1,8))>10000]/recordTarget/patientRole[identity:IdentityDoc[not(@nullFlavor)]]">
            <assert test="if (identity:IdentityDoc/identity:IdentityCardType/@code = ['10','11','16','17','18','19','33','35','44','49','51']) then count(id[2]/@nullFlavor)=[0,1] else count(id[2]/@nullFlavor)=0">У1-21. Элемент ClinicalDocument/recordTarget/patientRole/id[2] может иметь атрибут @nullFlavor в случае, если атрибут identity:IdentityDoc/identity:IdentityCardType/@code представлен со значениями "10", "11", "16", "17", "18", "19", "33", "35", "44", "49" или "51", иначе - атрибут @nullFlavor должен отсутствовать.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument[number(substring(effectiveTime/@value,1,8))-number(substring(recordTarget/patientRole/patient/birthTime/@value,1,8))>10000]/recordTarget/patientRole[identity:IdentityDoc[@nullFlavor]]/id[2]">
            <assert test="count(@nullFlavor)=0">У1-21. Элемент ClinicalDocument/recordTarget/patientRole/id[2] не должен иметь атрибут @nullFlavor.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument">
            <assert test="count(participant[@typeCode='IND'])>=0 and count(participant[@typeCode='IND'])&lt;=1">У1-27: Элемент ClinicalDocument МОЖЕТ содержать не более одного [0..1] элемента participant</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент participant не должен иметь атрибут @nullFlavor</assert>
            <assert test="@typeCode='IND'">У1-27: Элемент participant обязан содержать один атрибут @typeCode со значением "IND"</assert>
            <assert test="count(associatedEntity)=1">У1-27: Элемент participant ОБЯЗАН содержать один [1..1] элемент associatedEntity</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент associatedEntity не должен иметь атрибут @nullFlavor</assert>
            <assert test="@classCode='GUAR'">У1-27: Элемент associatedEntity обязан содержать один атрибут @classCode со значением "GUAR"</assert>
            <assert test="count(code)=1">У1-27: Элемент associatedEntity ОБЯЗАН содержать один [1..1] элемент code</assert>
            <assert test="count(identity:DocInfo)=1">У1-27: Элемент associatedEntity ДОЛЖЕН содержать один [1..1] элемент identity:DocInfo</assert>
            <assert test="count(scopingOrganization)>=0 and count(scopingOrganization)&lt;=1">У1-27: Элемент associatedEntity МОЖЕТ содержать не более одного [0..1] элемента scopingOrganization</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/code">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент code не должен иметь атрибут @nullFlavor</assert>
            <assert test="@code!=''">У1-27: Элемент code обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem='1.2.643.5.1.13.13.11.1039'">У1-27: Элемент code обязан содержать один атрибут @codeSystem со значением "1.2.643.5.1.13.13.11.1039"</assert>
            <assert test="@codeSystemVersion!=''">У1-27: Элемент code обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName!=''">У1-27: Элемент code обязан содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName!=''">У1-27: Элемент code обязан содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo[not(@nullFlavor)]">
            <assert test="count(identity:IdentityDocType)=1">У1-27: Элемент identity:DocInfo ОБЯЗАН содержать один [1..1] элемент identity:IdentityDocType</assert>
            <assert test="count(identity:InsurancePolicyType)=1">У1-27: Элемент identity:DocInfo ДОЛЖЕН содержать один [1..1] элемент identity:InsurancePolicyType</assert>
            <assert test="count(identity:Series)=1">У1-27: Элемент identity:DocInfo ДОЛЖЕН содержать один [1..1] элемент identity:Series</assert>
            <assert test="count(identity:Number)=1">У1-27: Элемент identity:DocInfo ДОЛЖЕН содержать один [1..1] элемент identity:Number</assert>
            <assert test="count(identity:INN)=1">У1-27: Элемент identity:DocInfo ДОЛЖЕН содержать один [1..1] элемент identity:INN</assert>
            <assert test="count(identity:effectiveTime)=1">У1-27: Элемент identity:DocInfo ДОЛЖЕН содержать один [1..1] элемент identity:effectiveTime</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:IdentityDocType">
            <assert test="@xsi:type='CD'">У1-27. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:IdentityDocType должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="count(@nullFlavor)=0">У1-27: Элемент identity:IdentityDocType не должен иметь атрибут @nullFlavor</assert>
            <assert test="@code!=''">У1-27: Элемент identity:IdentityDocType обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem='1.2.643.5.1.13.13.99.2.724'">У1-27: Элемент identity:IdentityDocType обязан содержать один атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.724"</assert>
            <assert test="@codeSystemVersion!=''">У1-27: Элемент identity:IdentityDocType обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName!=''">У1-27: Элемент identity:IdentityDocType обязан содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName!=''">У1-27: Элемент identity:IdentityDocType обязан содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:InsurancePolicyType[not(@nullFlavor)]">
            <assert test="@xsi:type='CD'">У1-27. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:InsurancePolicyType должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@code!=''">У1-27: Элемент identity:InsurancePolicyType должен содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem='1.2.643.5.1.13.13.11.1035'">У1-27: Элемент identity:InsurancePolicyType должен содержать один атрибут @codeSystem со значением "1.2.643.5.1.13.13.11.1035"</assert>
            <assert test="@codeSystemVersion!=''">У1-27: Элемент identity:InsurancePolicyType должен содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName!=''">У1-27: Элемент identity:InsurancePolicyType должен содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName!=''">У1-27: Элемент identity:InsurancePolicyType должен содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:Series[not(@nullFlavor)]">
            <assert test=".!=''">У1-27. Элемент identity:Series должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:Number[not(@nullFlavor)]">
            <assert test=".!=''">У1-27: Элемент identity:Number должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:INN[not(@nullFlavor)]">
            <assert test=".!=''">У1-27: Элемент identity:INN должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:effectiveTime[not(@nullFlavor)]">
            <assert test="count(identity:low)=1">У1-27: Элемент identity:effectiveTime ОБЯЗАН содержать один [1..1] элемент identity:low</assert>
            <assert test="identity:low/@xsi:type='TS'">У1-27. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:effectiveTime/identity:low должен иметь значение атрибута @xsi:type равное 'TS'.</assert>
            <assert test="count(identity:high)=1">У1-27: Элемент identity:effectiveTime ДОЛЖЕН содержать один [1..1] элемент identity:high</assert>
            <assert test="identity:high/@xsi:type='TS'">У1-27. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:effectiveTime/identity:high должен иметь значение атрибута @xsi:type равное 'TS'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:effectiveTime/identity:low">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент identity:low не должен иметь атрибут @nullFlavor</assert>
            <assert test="@value!=''">У1-27: Элемент identity:low обязан содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/identity:DocInfo/identity:effectiveTime/identity:high[not(@nullFlavor)]">
            <assert test="@value!=''">У1-27: Элемент identity:high должен содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент scopingOrganization не должен иметь атрибут @nullFlavor</assert>
            <assert test="count(id[1])=1">У1-27: Элемент scopingOrganization ДОЛЖЕН содержать один [1..1] элемент id (Уникальный идентификатор страховой компании)</assert>
            <assert test="count(identity:SMO)>=0 and count(identity:SMO)&lt;=1">У1-27: Элемент scopingOrganization МОЖЕТ содержать один [0..1] элемент name</assert>
            <assert test="count(name)=1">У1-27: Элемент scopingOrganization ОБЯЗАН содержать один [1..1] элемент name</assert>
            <assert test="count(telecom)>=1">У1-27: Элемент scopingOrganization ДОЛЖЕН содержать не менее одного [1..*] элемента telecom</assert>
            <assert test="count(addr)=1">У1-27: Элемент scopingOrganization ДОЛЖЕН содержать один [1..1] элемент addr</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/id[1][not(@nullFlavor)]">
            <assert test="@root='1.2.643.5.1.13.13.99.2.183'">У1-27: Элемент id должен содержать один атрибут @root со значением "1.2.643.5.1.13.13.99.2.183"</assert>
            <assert test="@extension!=''">У1-27: Элемент id должен содержать один атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/name">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент name не должен иметь атрибут @nullFlavor</assert>
            <assert test=".!=''">У1-27: Элемент name должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/identity:SMO">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент identity:SMO не должен иметь атрибут @nullFlavor</assert>
            <assert test="@code!=''">У1-27: Элемент identity:SMO обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem='1.2.643.5.1.13.13.99.3.44'">У1-27: Элемент identity:SMO обязан содержать один атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.3.44"</assert>
            <assert test="@codeSystemVersion!=''">У1-27: Элемент identity:SMO обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName!=''">У1-27: Элемент identity:SMO обязан содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName!=''">У1-27: Элемент identity:SMO обязан содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode = 'IND']/associatedEntity[code/@code = '1']/scopingOrganization[id[@nullFlavor]]">
            <assert test="count(identity:SMO)=1">У1-27: Элемент ClinicalDocument/participant/associatedEntity/scopingOrganization/identity:SMO обязан быть представлен.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization[id[1][not(@nullFlavor)]]">
            <assert test="count(identity:SMO)=0">У1-27: Одновременное заполнение элементов identity:SMO и id недопустимо</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/telecom[not(@nullFlavor)]">
            <assert test="count(@use!='')=[0,1]">У1-27: Элемент telecom должен содержать один атрибут @use с не пустым значением</assert>
            <assert test="if (@use) then @use!='' else(not(@use))">У1-27: Элемент telecom должен содержать один атрибут @use с не пустым значением</assert>
            <assert test="@value!=''">У1-27: Элемент telecom должен содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr[not(@nullFlavor)]">
            <assert test="count(@use!='')=[0,1]">У1-27: Элемент addr должен содержать один атрибут @use с не пустым значением</assert>
            <assert test="if (@use) then @use!='' else(not(@use))">У1-27: Элемент addr должен содержать один атрибут @use с не пустым значением</assert>
            <assert test="count(streetAddressLine)=1">У1-27: Элемент addr ОБЯЗАН содержать один [1..1] элемент streetAddressLine</assert>
            <assert test="count(address:stateCode)=1">У1-27: Элемент addr ОБЯЗАН содержать один [1..1] элемент address:stateCode</assert>
            <assert test="count(postalCode)=1">У1-27: Элемент addr ДОЛЖЕН содержать один [1..1] элемент postalCode</assert>
            <assert test="count(fias:Address)=1">У1-27: Элемент addr ДОЛЖЕН содержать один [1..1] элемент fias:Address</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/streetAddressLine">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент streetAddressLine не должен иметь атрибут @nullFlavor</assert>
            <assert test=".!=''">У1-27: Элемент streetAddressLine должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/address:stateCode">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент address:stateCode не должен иметь атрибут @nullFlavor</assert>
            <assert test="@code!=''">У1-27: Элемент address:stateCode обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.206','1.2.643.5.1.13.13.11.1093']">У1-27: Элемент address:stateCode обязан содержать один атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemVersion!=''">У1-27: Элемент address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName!=''">У1-27: Элемент address:stateCode обязан содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName!=''">У1-27: Элемент address:stateCode обязан содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/postalCode[not(@nullFlavor)]">
            <assert test=".!=''">У1-27: Элемент postalCode должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/fias:Address[not(@nullFlavor)]">
            <assert test="count(fias:AOGUID)=1">У1-27: Элемент fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID</assert>
            <assert test="count(fias:HOUSEGUID)=1">У1-27: Элемент fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/fias:Address/fias:AOGUID">
            <assert test="count(@nullFlavor)=0">У1-27: Элемент fias:AOGUID не должен иметь атрибут @nullFlavor</assert>
            <assert test=".!=''">У1-27: Элемент fias:AOGUID должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity/scopingOrganization/addr/fias:Address/fias:HOUSEGUID[not(@nullFlavor)]">
            <assert test=".!=''">У1-27: Элемент fias:HOUSEGUID должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument[code[@code='85']]">
            <assert test="count(participant[@typeCode='REF'])>=0 and count(participant[@typeCode='REF'])&lt;=1">У1-28. Элемент ClinicalDocument может иметь 1 элемент participant.</assert>
        </rule>
    ...
    <pattern>
        <rule context="ClinicalDocument">
            <assert test="count(inFulfillmentOf)>=0 and count(inFulfillmentOf)&lt;=1">У1-29. Элемент ClinicalDocument может иметь 1 элемент inFulfillmentOf.</assert>
        </rule>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RESCONS']/component/section[code/@code='REGIME']">
            <assert test="count(entry[observation/code[@code='807']])&lt;=1">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RESCONS']/component/section[code/@code='REGIME'] должен иметь не более 1 элемента entry.</assert>
        </rule>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']">
            <assert test="count(entry)>=1">У3-23. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS'] должен иметь не менее 1 элемента entry.</assert>
        </rule>
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SERVICES']/entry/act">
            <report test="@nullFlavor">У3-24. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SERVICES']/entry/act не должен иметь атрибут @nullFlavor.</report>
...
<!-- 12.09.2022 - v.1.0.0: Модуль разработан -->
    ...
    <pattern>
        <rule context="//medService:servicePlace[@codeSystem='1.2.643.5.1.13.13.11.1008']">
            <assert test="@code=['1','2','4','8']">Допустимые значения для элементов medService:servicePlace[@codeSystem='1.2.643.5.1.13.13.11.1008']: 1, 2, 4, 8</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="//code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['800','801','804','805','806','807','808','809','810','811','4058','4083','4115','7002','7003','7004','7005','7006','11002','11003']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 800, 801, 804, 805, 806, 807, 808, 809, 810, 811, 4058, 4083, 4115, 7002, 7003, 7004, 7005, 7006, 11002, 11003</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//code[@codeSystem='1.2.643.5.1.13.13.99.2.197']">
            <assert test="@code=['DOCINFO','BENEFITS','ANAM','LANAM','VITALPARAM','RESCONS','DGN','REGIME','LINKDOCS','SERVICES']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.197']: DOCINFO, BENEFITS, ANAM, LANAM, VITALPARAM, RESCONS, DGN, REGIME, LINKDOCS, SERVICES</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='DOCINFO']/entry/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['809','800','7003','801','7002']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 809, 800, 7003, 801, 7002</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='DOCINFO']/entry/observation[code/@code='7002']/entryRelationship/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['7004','7005']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 7004, 7005</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="//section[code/@code='LANAM']/entry/observation[code/@codeSystem='1.2.643.5.1.13.13.11.1053']/entryRelationship/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['4115','4058']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 4115, 4058</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='LANAM']/entry/observation[code/@codeSystem='1.2.643.5.1.13.13.11.1053']/entryRelationship/observation[code/@code='4058']/entryRelationship/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['4083']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 4083</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='RESCONS']/entry/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['804','805','806','808','810']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 804, 805, 806, 808, 810</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='RESCONS']/component/section/code[@codeSystem='1.2.643.5.1.13.13.99.2.197']">
            <assert test="@code=['DGN','REGIME']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.197']: DGN, REGIME</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='RESCONS']/component/section[code/@code='DGN']/entry/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['806']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 806</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='RESCONS']/component/section[code/@code='REGIME']/entry/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['807']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 807</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="//section[code/@code='LINKDOCS']/entry/act/entryRelationship/observation/code[@codeSystem='1.2.643.5.1.13.13.99.2.166']">
            <assert test="@code=['11002','11003']">Допустимые значения для элементов code[@codeSystem='1.2.643.5.1.13.13.99.2.166']: 11002, 11003</assert>
        </rule>
    </pattern>
    <pattern>
